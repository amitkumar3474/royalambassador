...
<div class="top-nav">
    <ul>
        <li class="first-nav">
            <a href="https://www.theroyalambassador.com/" target="_blank">
                <img src="{{ asset('backend/assets/img/ra-org-inv-spaced.png') }}" alt="">
            </a>
        </li>
        <li>
            <a href="{{ route('admin.booking.restaurant.reservation') }}" title="Restaurant Reservation">
                <svg class="svg-inline--fa fa-utensils" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="utensils" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M416 0C400 0 288 32 288 176V288c0 35.3 28.7 64 64 64h32V480c0 17.7 14.3 32 32 32s32-14.3 32-32V352 240 32c0-17.7-14.3-32-32-32zM64 16C64 7.8 57.9 1 49.7 .1S34.2 4.6 32.4 12.5L2.1 148.8C.7 155.1 0 161.5 0 167.9c0 45.9 35.1 83.6 80 87.7V480c0 17.7 14.3 32 32 32s32-14.3 32-32V255.6c44.9-4.1 80-41.8 80-87.7c0-6.4-.7-12.8-2.1-19.1L191.6 12.5c-1.8-8-9.3-13.3-17.4-12.4S160 7.8 160 16V150.2c0 5.4-4.4 9.8-9.8 9.8c-5.1 0-9.3-3.9-9.8-9L127.9 14.6C127.2 6.3 120.3 0 112 0s-15.2 6.3-15.9 14.6L83.7 151c-.5 5.1-4.7 9-9.8 9c-5.4 0-9.8-4.4-9.8-9.8V16zm48.3 152l-.3 0-.3 0 .3-.7 .3 .7z"></path></svg>
            </a>
        </li>
        <li>
            <a href="{{route('admin.room.availability.calendar')}}" title="Availability Calendar">
        ...
        <li>
            <a href="{{ route('admin.customer.index') }}" title="All Customers">
        ...
        <li>
            <a href="{{ route('admin.customer.create') }}" title="Add Customers">
        ...
        <li>
            <a href="#" title="Pending Tasks">
                <svg class="svg-inline--fa fa-product-hunt" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="product-hunt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M326.3 218.8c0 20.5-16.7 37.2-37.2 37.2h-70.3v-74.4h70.3c20.5 0 37.2 16.7 37.2 37.2zM504 256c0 137-111 248-248 248S8 393 8 256 119 8 256 8s248 111 248 248zm-128.1-37.2c0-47.9-38.9-86.8-86.8-86.8H169.2v248h49.6v-74.4h70.3c47.9 0 86.8-38.9 86.8-86.8z"></path></svg>
            </a>
        </li>
        <li>
            <a href="{{route('admin.event.index')}}" title="All Events">
                <svg class="svg-inline--fa fa-elementor" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="elementor" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M.361 256C.361 397 114 511 255 511C397 511 511 397 511 256C511 116 397 2.05 255 2.05C114 2.05 .361 116 .361 256zM192 150V363H149V150H192zM234 150H362V193H234V150zM362 235V278H234V235H362zM234 320H362V363H234V320z"></path></svg>
            </a>
        </li>
        <li>
            <a href="{{route('admin.event.tentative-event')}}" title="Tentative Events">
        ...
        <li>
            <a href="#" title="There are 3 Past Due Deposits">
                <span class="warning" title="There are 4 Past Due Deposits">$ x 4</span>
            </a>
        </li>
    </ul>
    <div class="search_box_outer">
        <input class="search-input" type="text" placeholder="Quick Search">       
