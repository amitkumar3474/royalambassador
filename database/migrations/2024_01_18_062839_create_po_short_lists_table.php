...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('po_short_lists', function (Blueprint $table) {
            ...
            $table->integer('lnk_prod_vintage')->nullable()->comment('Sometimes it is for a specific vintage under a wine and this column keeps the link. Linked to PRODUCT_GEN');
    ...
    {
        Schema::dropIfExists('po_short_lists');
    }
};
