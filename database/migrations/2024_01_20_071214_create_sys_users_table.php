...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sys_users', function (Blueprint $table) {
            ...
            $table->string('pwd', 32)->nullable()->comment('Password as plain text or hashed');
            ...
            $table->tinyInteger('email_verified')->nullable()->comment('Is the email address of this user verified or not. This menas that user has clicked on the link sent to his email, if needed');
